    ...
    try {
        const requestOption = {
            ...
            headers: {
                ...
                'User-Agent': 'OAuth poe-bot/1.0.0 (contact:tony020409@gmail.com)',
        ...
        const res = await fetch('http://web.poe.garena.tw/api/trade/exchange/熔火聯盟', requestOption) //TODO 每季要改成新聯盟 
        // await delay(3000)
